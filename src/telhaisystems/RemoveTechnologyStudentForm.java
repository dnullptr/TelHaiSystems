 ...
 * @author Nitzan
 */
public class RemoveTechnologyStudentForm extends javax.swing.JFrame {

    /**
     * Creates new form RemoveAcademyStudentForm
     */
    public RemoveTechnologyStudentForm() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        idlbl.setText("Insert Student ID to Remove");
    ...
    private void removeBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_removeBtnActionPerformed
       ...
       List<Student> list=getTechnologyStuFromSQL();
        ...
        if(JOptionPane.showConfirmDialog(rootPane, "Are you sure you want to Remove ID:"+ID+"?", "Are You Sure?", WIDTH)==JOptionPane.YES_OPTION)
        {
            for(Student i : list)
                if(i.getId().equals(ID))
                    Found=true;
            if(removeStudentFromSQL(ID) && Found) 
            JOptionPane.showMessageDialog(rootPane, "ID:"+ID+"Successfully Removed! Bye From TelHai");
